...
def graphique():
    ...
    icone=PhotoImage(file=r"C:\Users\hp\Desktop\Projet Python\weather.png")  # L'image a faire comme icone doit etre obligatoirement sous format png ou gif
    root.iconphoto(False,icone)

    # Création d'un cadre pour placer les widgets
    frame = Frame(root, padx=10, pady=10,bg="#E6E6FA")
    frame.pack()
    image = Image.open(r"C:\Users\hp\Desktop\Projet Python\search bar.png")
    ...
    imagefe = Image.open(r"C:\Users\hp\Desktop\Projet Python1\Projet Python\simulation2.png")
    ...
    labelefe.place(x=710,y=300)
                # Chargement de la barre de recherche
    imagef = Image.open(r"C:\Users\hp\Desktop\Projet Python1\Projet Python\simulation.png")
